  ...
  return (
    <div className="bg-white h-full">
        ...
        <div className="flex flex-col items-center pb-72 pt-20 px-[120] ">
          <div className="flex">
            <h1 className="text-8xl mb-8 text-orange-500 pr-12">
              Welcome to{" "}
              <h1 className="text-orange-950 pt-3">Bhookh Lagi Hai?</h1>
            </h1>
          ...
          <p className="text-slate-800 text-xl mt-14 font-semibold shadow-lg shadow-gray-300 px-2 py-4 bg-gray-100">
            ...
            delivering delightful dining experiences right to your fingertips.
            Our journey began with a simple yet profound vision - to
            revolutionize the way you indulge in your favorite meals. Whether
            you're yearning for comfort food, exploring exotic global cuisines,
            or seeking wholesome alternatives, we've got you covered!
          </p>
        </div>
      </div>
      <div className="h-[550]">
        <div className="text-center font-bold shadow-xl text-8xl text-orange-950 mt-[80]   pt-2 pb-6">
          Our Story
        </div>
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          ...
          <p className="text-2xl mt-11 text-slate-800 mx-14 pl-4">
            Founded in 2024, "Bhookh Lagi Hai?" started as a small team of food
      ...
      <div className="h-full pb-16">
        <div className="text-center font-bold shadow-xl sha text-8xl text-orange-500 mt-[80]  pt-2 pb-8">
          What sets us apart
        </div>
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          <img src="https://bhookh-lagi-hai.vercel.app/Cultinary.2ce20b13.jpg" className="h-[300] rounded-md ml-8" alt="" />
          <div>
            <h1 className="font-semibold text-slate-800 mx-14 text-3xl mt-14">
              Flavorful Culinary Odyssey
            </h1>
            <p className="text-2xl mt-9 text-slate-800 mx-14 ">
        ...
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          <div className="ml-8 pr-14">
            <h1 className="font-semibold text-slate-800  text-3xl  mt-14">
              Seamless User Experience
            </h1>
            <p className="text-2xl mt-9 text-slate-800">
        ...
        <div class="p-6 mt-10 mx-16 rounded-md shadow-[0px_18px_40px_4px_rgba(0,0,0,0.56)] flex">
          ...
          <div>
            ...
            <p className="text-2xl mt-9 text-slate-800 mx-14 ">
              At "Bhookh Lagi Hai?," we take pleasure in spoiling our users with
