...
export const QualityContainer = ({handleClick}) => {
  ...
  return (
    <div className="text-orange-500 px-5 text-center sm:text-left bg-white sm:h-[910] md:h-[810] lg:h-[664] flex  flex-col lg:flex-row justify-between items-center sm:px-16">
      <div className="max-w-xl">
       ...
       <button className="mt-8 mx-2  p-3 rounded-xl text-white bg-orange-500 hover:bg-orange-600 sm:mt-5" onClick={handleClick}>
            Get Started
        </button>
        </div>  
